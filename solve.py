...
vars_set = set()
for e in (equation_list_A+equation_list_B):
    if not e:
        continue
    vars_set.update(e.free_symbols)
print("variable_number =", len(vars_set))
print("eq_number =", len(equation_list_A+equation_list_B))
