...
for ab in map_ansatz('zero_two_A',[[0,0],[1,1],[1,1],[1,1]],2):
    print(ab['id'])
    print(ab['index_based'])

for ab in map_ansatz('zero_two_B',[[0,0],[1,1],[0,2],[1,3],[1,3]],4):
    print(ab['id'])
    print(ab['index_based'])
...
for ab in map_ansatz ('one_two_C',[[0,0],[0,1],[0,1],[1,2]],4):
    print(ab['id'])
    print(ab['index_based'])
'''
...
for ab in action_class('one_two_B',[[1,1],[1,1],[0,2],[2,3]],4):
    print(ab)
